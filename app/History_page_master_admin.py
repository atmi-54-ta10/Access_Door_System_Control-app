...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.logo_image_data_log = ctk.CTkImage(Image.open(os.path.join(image_path, "Data_logging hitam.png")), size=(75, 75))
        self.logo_image_temperature = ctk.CTkImage(Image.open(os.path.join(image_path, "thermometer hitam.png")), size=(75, 75))
        ...
        self.name_of_page = ctk.CTkLabel(master=self.main_frame,text="History", text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"))
        self.name_of_page.place(relx=0.01, rely=0.01)

         #button edit data
        self.btn_data_log = ctk.CTkButton(master=self.main_frame,width=200,height=200,text="Report",text_color="#004643", fg_color="#abd1c6",corner_radius=30,font=ctk.CTkFont(size=20,weight="bold"), image=self.logo_image_data_log,compound="top",command=self.btn_report)
        self.btn_data_log.place(relx=0.22, rely=0.38)

        #button Control
        self.btn_temp_report = ctk.CTkButton(master=self.main_frame,width=200,height=200,text="Temperature",text_color="#004643", fg_color="#abd1c6",corner_radius=30,font=ctk.CTkFont(size=20,weight="bold"), image=self.logo_image_temperature,compound="top",command=self.btn_temp)
        self.btn_temp_report.place(relx=0.62, rely=0.38)
    ...
    def btn_report(self):
        self.destroy()
        import datalog_master_admin as dma
        dma.main()

    
    def btn_temp(self):
        self.destroy()
        import temperature_master as dma
        dma.main()
