...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.name_of_page = ctk.CTkLabel(master=self.main_frame,text="Monitoring", text_color="#004643",font=ctk.CTkFont(size=25, weight="bold"))
        self.name_of_page.place(relx=0.01, rely=0.01)

        #stat door
        self.status_frame_door =ctk.CTkFrame(self.main_frame,corner_radius=20,height=150, width=200,fg_color="#004643")
        ...
        #stat master
        self.status_frame_master =ctk.CTkFrame(self.main_frame,corner_radius=20,height=150, width=250,fg_color="#004643")
        ...
        self.label_master = ctk.CTkLabel(master=self.status_frame_master,text="Master Availability:", text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"), justify="left",wraplength=300)
        ...
        #stat tap card 
        self.frame_num_of_tap_card =ctk.CTkFrame(self.main_frame,corner_radius=20,height=150, width=175,fg_color="#004643")
        ...
        self.label_notc = ctk.CTkLabel(master=self.frame_num_of_tap_card,text="Tap Card:", text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"), justify="left")
        # self.label_notc.place(relx=0.1,rely=0.1)
        self.label_notc.grid(row=0,column=0,pady=(15,20),padx=(40))

        self.num_of_tap_card = ctk.CTkLabel(master=self.frame_num_of_tap_card,text='', text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"))
        # self.num_of_tap_card.place(relx=0.1,rely=0.5)
        self.num_of_tap_card.grid(row=1,column=0,pady=(0,20))

        #stat tap card 
        self.frame_panel =ctk.CTkFrame(self.main_frame,corner_radius=20,height=150, width=175,fg_color="#004643")
        ...
        self.label_tempPanel = ctk.CTkLabel(master=self.frame_panel,text="Panel:", text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"), justify="left")
        # self.label_tempPanel.place(relx=0.1,rely=0.1)
        self.label_tempPanel.grid(row=0,column=0,pady=(15,10),padx=(40))

        self.temp_panel = ctk.CTkLabel(master=self.frame_panel,text='', text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"))
        # self.temp_panel.place(relx=0.1,rely=0.5)
        self.temp_panel.grid(row=1,column=0,pady=(0,10))
        self.temp_panel_date = ctk.CTkLabel(master=self.frame_panel,text='', text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"))
        # self.temp_panel.place(relx=0.1,rely=0.5)
        self.temp_panel_date.grid(row=2,column=0,pady=(0,10),padx=20)


        #stat tap card 
        self.frame_Emlock =ctk.CTkFrame(self.main_frame,corner_radius=20,height=150, width=175,fg_color="#004643")
        self.frame_Emlock.place(relx=0.5,rely=0.45)
        self.frame_Emlock.grid_columnconfigure(0,weight=1)
        self.frame_Emlock.grid_rowconfigure((0,1),weight=1)

        self.label_emlock = ctk.CTkLabel(master=self.frame_Emlock,text="EmLock:", text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"), justify="left")
        # self.label_emlock.place(relx=0.1,rely=0.1)
        self.label_emlock.grid(row=0,column=0,pady=(15,10),padx=(40))
        self.temp_emlock = ctk.CTkLabel(master=self.frame_Emlock,text='', text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"))
        # self.temp_emlock.place(relx=0.1,rely=0.5)
        self.temp_emlock.grid(row=1,column=0,pady=(0,10))
        self.temp_emlock_date = ctk.CTkLabel(master=self.frame_Emlock,text='', text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"))
        # self.temp_emlock.place(relx=0.1,rely=0.5)
        self.temp_emlock_date.grid(row=2,column=0,pady=(0,10),padx=20)
        #btn back
        ...
        self.btn_back.place(relx=0.02, rely=0.9)
        self.req()
