...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.name_of_page = ctk.CTkLabel(master=self.main_frame,text="Temperature Log", text_color="#004643",font=ctk.CTkFont(size=25, weight="bold"))
        ...
        self.tab_view = ctk.CTkTabview(master=self.main_frame, corner_radius=5, width=825, height=440, fg_color="#004643",
                                       text_color="#000000", segmented_button_fg_color="#004643",
        ...
        self.combobox_form_export = ctk.CTkComboBox(master=self.main_frame,values=self.format_export, width=100,height=35, fg_color="#ffffff",text_color="#000000",dropdown_fg_color="#ffffff",dropdown_text_color="#000000",corner_radius=25,font=ctk.CTkFont(size=15))
    ...
    def btnback (self):
        self.destroy()
        import History_page_admin as dma
        dma.main() 
