...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.name_of_page = ctk.CTkLabel(master=self.main_frame,text="Datalogging", text_color="#abd1c6",font=ctk.CTkFont(size=25, weight="bold"))
        ...
        self.combobox_form_export = ctk.CTkComboBox(master=self.main_frame,values=self.format_export, width=100,height=35, fg_color="#004643",text_color="#abd1c6",dropdown_fg_color="#004643",dropdown_text_color="#abd1c6",font=ctk.CTkFont(size=15), dropdown_font=ctk.CTkFont(size=20))
        self.combobox_form_export.set(value= self.format_export[0])
        self.combobox_form_export.place(relx=0.88,rely=0.5)


        self.btn_export_data = ctk.CTkButton(master=self.main_frame,width=100,height=70,text="Export",text_color="#004643", fg_color="#abd1c6",corner_radius=20,font=ctk.CTkFont(size=12,weight="bold"), image=self.logo_image_export_data,compound="top", anchor="c", command= self.download_file)
    ...
    def create_csv(self):
        ...
        with open("../../Documents/Data_Log/Door_Access/"+file_name, 'w') as csvfile:
            header =["Date", "Time", "Name", "Job", "Platform", "Action"]
