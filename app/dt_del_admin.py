...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.logo_image_delete_data = ctk.CTkImage(Image.open(os.path.join(image_path, "delete-user hitam.png")), size=(75, 75))
        ...
        self.name_of_page = ctk.CTkLabel(master=self.main_frame,text="Delete data", text_color="#004643",font=ctk.CTkFont(size=25, weight="bold"))
        self.name_of_page.place(relx=0.01, rely=0.01)

        self.frame_kanan = ctk.CTkFrame(master=self.main_frame, height=467, width=400,fg_color="#004643")
        ...
        self.tab_view = ctk.CTkTabview(master=self.main_frame, corner_radius=5, width=460, height=480, fg_color="#004643",
                                       text_color="#abd1c6", segmented_button_fg_color="#004643",
        ...
        self.name = ctk.CTkEntry(master=self.frame_kanan, textvariable=self.name_slct,height=28,width=350,fg_color="#004643", corner_radius=25, text_color="#abd1c6",border_color="#abd1c6",font=ctk.CTkFont(size=15),state="disabled")
        ...
        self.job = ctk.CTkEntry(master=self.frame_kanan, textvariable=self.job_slct,height=30,width=350,fg_color="#004643", corner_radius=25,  text_color="#abd1c6",border_color="#abd1c6",font=ctk.CTkFont(size=15),state="disabled")
        ...
        self.ni = ctk.CTkEntry(master=self.frame_kanan, textvariable=self.id_number_slct,height=28,width=350,fg_color="#004643", corner_radius=25,  text_color="#abd1c6",border_color="#abd1c6",font=ctk.CTkFont(size=15),state="disabled")
        self.ni.place(relx=0.04, rely= 0.38)
        self.label_role = ctk.CTkLabel(master=self.frame_kanan, text="ID Number", font=ctk.CTkFont(size=17, weight="bold"),text_color="#abd1c6")
        self.label_role.place(relx=0.06, rely=0.32)
        #tombol 
        self.btn_delete_data = ctk.CTkButton(master=self.frame_kanan,width=150,height=150,text="Delete",text_color="#000000", fg_color="#abd1c6",corner_radius=20,font=ctk.CTkFont(size=20,weight="bold"), image=self.logo_image_delete_data,compound="top", anchor="c", command= self.del_data)
        self.btn_delete_data.place(relx=0.1, rely=0.65) 

        self.btn_clear_data = ctk.CTkButton(master=self.frame_kanan,width=150,height=150,text="Clear",text_color="#000000", fg_color="#abd1c6",corner_radius=20,font=ctk.CTkFont(size=20,weight="bold"), image=self.logo_image_clear,compound="top",command=self.clear)
